...
|---|---|---|---|---|---|---|
| 入口 | 展示積木 | 必要 | 呈現 3D 卡片、說明與操作回饋 | 網站資料 → 可操作入口 | HTML / CSS | 滿版、響應式、鍵盤可操作 |
| 守門＋調度 | 邏輯積木 | 必要 | 控制分類、旋轉、暫停、選取與網址開啟 | 指標事件 → 卡片狀態 | 原生 JavaScript | 自動巡航、雙向控制、暫停、分類 |
