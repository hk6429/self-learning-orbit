...
- 15 座學習網站的右下角共用工具預設收合成單一按鈕，需要時再展開「家庭共學」、「學習紀錄」、「自學星圖」與公開計數。
- 15 座網站共用「學習紀錄」入口，提供學生、家長、教師 60 秒使用說明、身分狀態、本機自動保存提示與進度摘要。
...
| 工具箱 | 檔案積木 | 必要 | 保存經驗收的網站畫面 | 公開網站 → WebP 縮圖 | `assets/previews/` | 15 張截圖分階段載入 |
...
- 已將使用者提供的重複網址合併，共收錄 15 個可正常開啟的網站。
